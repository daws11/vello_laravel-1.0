...
<section class="section privacy-policy" id="privacy-policy">
    <div class="container" style="max-width: 800px; margin: 0 auto; padding-top: 20px;">
        ...
        <!-- Paragraf Pengantar -->
        <p class="text">
            Di <strong>Vello Technology Digital</strong>, kami berkomitmen untuk melindungi privasi dan data pribadi Anda. Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi informasi yang Anda berikan ketika menggunakan layanan kami.
        </p>

        <!-- Informasi yang Kami Kumpulkan -->
        <h3 class="h3 ">1. Informasi yang Kami Kumpulkan</h3>
        <p class="text">
        ...
        <h3 class="h3 ">2. Bagaimana Kami Menggunakan Informasi Anda</h3>
        <p class="text">
        ...
        <h3 class="h3 ">3. Penyimpanan dan Keamanan Data</h3>
        <p class="text">
        ...
        <h3 class="h3 ">4. Berbagi Informasi dengan Pihak Ketiga</h3>
        <p class="text">
        ...
        <ul class="text">
            ...
            <li>Jika diperlukan untuk melindungi hak, privasi, keselamatan, atau properti Vello Technology Digital atau publik.</li>
        ...
        <!-- Penggunaan Cookies -->
        <h3 class="h3 ">5. Penggunaan Cookies</h3>
        <p class="text">
        ...
        <!-- Perubahan Kebijakan -->
        <h3 class="h3 ">7. Perubahan Kebijakan Privasi</h3>
        <p class="text">
        ...
        <p class="text">
            ...
            <a href="mailto:info@vello.tech">info@vello.tech</a>.
        </p>
    </div>
</section>
@endsection
